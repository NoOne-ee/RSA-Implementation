...
% rsa_chapter.tex
%
% Chapter "RSA Implementation" — body-only version, designed to be included
% from a master report via \input{rsa_chapter.tex}.
%
% Use this file when the RSA content is one chapter of a larger document
% (for example: master report has Chapter 1 = AES, Chapter 2 = RSA).
%
% Required packages in the master preamble:
%   graphicx, amsmath, amssymb, booktabs, array, listings, xcolor,
%   hyperref, caption, tikz (with libraries shapes,arrows,positioning,
%   fit,calc), float, geometry
%
% For the standalone preview version (with its own \documentclass and
% \begin{document}), use rapport_RSA.tex instead.
% =============================================================================


\chapter{RSA Implementation}
...
\subsection{Multiplication de Montgomery}
...
\subsubsection{Algorithme bit-sériel}
...
\subsection{Exponentiation modulaire par Montgomery}
...
\subsection{Test de primalité de Miller-Rabin}
...
\subsection{Algorithme d'Euclide étendu (EXT\_GCD)}
...
% ----------------------------------------------------------------------
\subsection{RSA\_PKG --- Package de constantes}
\label{sec:pkg}
...
% ----------------------------------------------------------------------
\subsection{RANDOM\_GEN --- Générateur pseudo-aléatoire}
\label{sec:rng}
...
% ----------------------------------------------------------------------
\subsection{MILLER\_RABIN --- Test de primalité}
\label{sec:mr}
...
% ----------------------------------------------------------------------
\subsection{EXT\_GCD --- Euclide étendu}
\label{sec:gcd}
...
% ----------------------------------------------------------------------
\subsection{MONTGOMERY\_MULT --- Multiplieur de Montgomery}
\label{sec:mont_mult}
...
% ----------------------------------------------------------------------
\subsection{MOD\_MONTGOMERY\_EXP --- Exponentiation modulaire}
\label{sec:mod_exp}
...
% ----------------------------------------------------------------------
\subsection{RSA --- Wrapper d'exponentiation}
\label{sec:rsa}
...
% ----------------------------------------------------------------------
\subsection{RSA\_KEYGEN --- Génération de clés}
\label{sec:keygen}
...
% ======================================================================
\section{RSA\_TOP --- Entité Principale}
\label{ch:top}
...
\subsection{Séquence d'opérations}
...
\subsection{Machine d'états principale}
...
\subsection{Simulation complète (round-trip)}
\begin{figure}[H]
\centering
...
\subsection{Performance mesurée}
...
\subsection{Résultat global de simulation}
\begin{figure}[H]
\centering
\fbox{\parbox{0.9\textwidth}{\centering\vspace{4cm}
...
% ======================================================================
\section{Intégration avec le Processeur RISC-V}
\label{ch:riscv}

\subsection{Principe d'intégration}
...
\subsection{Registres mémoire-mappés (proposition)}
...
%                         ANNEXES
% ======================================================================
\section{Code VHDL --- Extraits}

\subsection{MONTGOMERY\_MULT (complet)}
...
\subsection{RSA\_TOP --- Machine d'états (extrait)}
